...
"Plasma" "KDE Plasma (With Audio Fix)" \
"XFCE" "XFCE4" \
"LXQt" "LXQt" \
...
# Added xdg-user-dirs for better DE integration
BASE_PKGS="base base-devel linux linux-firmware intel-ucode amd-ucode dinit elogind-dinit dbus-dinit doas vi networkmanager networkmanager-dinit wpa_supplicant grub efibootmgr ntfs-3g dosfstools mtools libnewt xorg-server xorg-xinit haveged haveged-dinit xdg-user-dirs"
...
# Pipewire Autostart (Crucial for non-KDE WMs)
...
# Install DE/WM with Plasma Audio Fix
case $DE_CHOICE in
    Plasma) artix-chroot /mnt pacman -S --noconfirm plasma kde-applications sddm-dinit xdg-desktop-portal-kde plasma-pa ;;
    XFCE)   artix-chroot /mnt pacman -S --noconfirm xfce4 xfce4-goodies lightdm-dinit xdg-desktop-portal-gtk ;;
...
for svc in dbus NetworkManager elogind haveged $DM; do
...
umount -R /mnt
whiptail --title "$TITLE" --msgbox "Installation complete! Plasma audio fix applied." 10 60
reboot
